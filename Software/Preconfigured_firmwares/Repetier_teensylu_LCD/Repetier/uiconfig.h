...
#error  'compil test hhh'
#define UI_DISPLAY_RS_PIN		24//12//63		// PINK.1, 88, D_RS
#define UI_DISPLAY_RW_PIN		-1
#define UI_DISPLAY_ENABLE_PIN	        1//17//65		// PINK.3, 86, D_E
#define UI_DISPLAY_D0_PIN		39//-1//59		// PINF.5, 92, D_D4
#define UI_DISPLAY_D1_PIN		40//-1//64		// PINK.2, 87, D_D5
#define UI_DISPLAY_D2_PIN		41//-1//44		// PINL.5, 40, D_D6
#define UI_DISPLAY_D3_PIN		42//-1//66		// PINK.4, 85, D_D7
#define UI_DISPLAY_D4_PIN		39//59		// PINF.5, 92, D_D4
#define UI_DISPLAY_D5_PIN		40//64		// PINK.2, 87, D_D5
#define UI_DISPLAY_D6_PIN		41//44		// PINL.5, 40, D_D6
#define UI_DISPLAY_D7_PIN		42//66		// PINK.4, 85, D_D7
