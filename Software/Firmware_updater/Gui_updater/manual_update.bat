...
if %input%==1 set fm="firmwares_emt\uDelta_Base_v1.00.hex"
if %input%==2 set fm="firmwares_emt\uDelta_bed_v1.00.hex"
if %input%==3 set fm="firmwares_emt\uDelta_LCD_v0.9.hex"
if %input%==4 set fm="firmwares_emt\uDelta_LCD_bed_v0.9.hex"
echo ---------------------
...
set /p input="PORT: "
avrdude.exe avrdude.conf -v -v -v -v -pat90usb1286 -cavr109 -P\\.\%input% -b115200 -D -Uflash:w:%fm%:i
